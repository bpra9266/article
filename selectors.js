const SELECTOR_CHEF_NAME = '.article-hero-split-text>h1';
const SELECTOR_CATEGORY_TYPE = '.article-hero-split-text>span';
const SELECTOR_ARTICLE_SLOGAN = '.article-hero-split-text>p';
